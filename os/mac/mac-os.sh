...
defaults write NSGlobalDomain AppleLanguages -array "es-ES" "es-PE" "en"
defaults write NSGlobalDomain AppleLocale -string "es_PE@currency=PEN"
defaults write NSGlobalDomain AppleMeasurementUnits -string "Centímetros"
...
# Crear carpertas en directorio de usuario
mkdir -p ~/Dido
mkdir -p ~/Touch-Consulting